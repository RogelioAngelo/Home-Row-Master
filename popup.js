/* ============================================================
   HOME ROW MASTER — popup.js
   Game logic: sequences, accuracy, streak, best streak
   ============================================================ */
...
// Keyboard key → element ID mapping
const KEY_MAP = {
...
function loadStats() {
  ...
  if (['letters', 'words', 'poems', 'facts'].includes(savedMode)) {
  ...
  if (savedSeqLength) {
    state.seqLength = parseInt(savedSeqLength, 10);
